$(function(){
	...
	(function(){
		var aLi = $("#menu li");
		var oText = $('#search').find('.from .text')
		var arrText = [
			'例如：荷棠鱼坊烧鱼 或 樱花日本料理',
...
//		var oUl = $('.update ul')
		...
		var arrData = [
			...
			{ 'name':'锤锤', 'time':6, 'title':'国台办回应王郁琦', 'url':'http://www.miaov.com/2013/#about' },
			{ 'name':'嘻嘻', 'time':7, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/#message' },
			{ 'name':'梅梅', 'time':8, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/' },
			{ 'name':'晓晓', 'time':9, 'title':'广东3天抓获涉黄疑犯', 'url':'http://www.miaov.com/2013/#curriculum' },
			{ 'name':'红红', 'time':10, 'title':'国台办回应王郁琦', 'url':'http://www.miaov.com/2013/#about' },
			{ 'name':'大大', 'time':11, 'title':'那些灿烂华美的瞬间', 'url':'http://www.miaov.com/2013/#message' }
		]
	...
	(function(){
		...
		aImg.hover(function(){
			...
			oPrompt.show().css({'left':iLeft,'top':iTop,'z-index':3});
