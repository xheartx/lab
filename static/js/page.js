...
(function () {
    ...
    if (top == self) {
        ...
        topBar.innerHTML = '' + 
            '<a class="home" target="_blank" href="http://xheartx.com">个人首页</a>' +
            '<a class="lab" target="_blank" href="http://blog.xheartx.com">我的博客</a>' +
            '<a class="lab" target="_blank" href="http://xheartx.com/WebNav/">前端导航</a>' +
